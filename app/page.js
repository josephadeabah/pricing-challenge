    ...
    <div className="flex flex-col items-center h-full gap-8">
      ...
      <div className="relative bg-white rounded-lg mx-auto h-fit max-h-lg w-full max-w-md py-4 mt-10 shadow-xl">
        <div className="flex flex-col items-center">
          ...
          {/* For desktop layout */}
          <div className="hidden md:flex justify-between items-center w-full px-4 mt-2">
            <p className="font-semibold text-sm opacity-60 text-gray-500">{sliderValue}K Pageviews</p>
            <p className="font-bold text-[60px] flex items-center">
              ${getPrice()}
          ...
          <div className="flex justify-between gap-2 items-center text-xs font-medium px-4 text-gray-400 mt-12">
